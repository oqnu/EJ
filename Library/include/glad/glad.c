/*
    ...
    OpenGL loader generated by glad 0.1.34 on Mon Sep 11 04:23:46 2023.
...
static int get_exts(void) {
    ...
    if(max_loaded_major < 3) {
        ...
        nu_exts_i = 0;
        glGetIntegerv(GL_NUM_EXTENSIONS, &nu_exts_i);
        if (nu_exts_i > 0) {
            exts_i = (char **)malloc((size_t)nu_exts_i * (sizeof *exts_i));
        }
        ...
        for(index = 0; index < (unsigned)nu_exts_i; index++) {
...
static void free_exts(void) {
    if (exts_i != NULL) {
        int index;
        for(index = 0; index < nu_exts_i; index++) {
